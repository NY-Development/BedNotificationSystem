...
import { Mail, Lock } from 'lucide-react'; // Added Lucide icons
...
        <div className="w-full lg:w-1/2 flex items-center justify-center sm:p-10">
...
                </div>
              )}
              <div className="rounded-md space-y-4"> {/* Increased spacing */}
...
                    required
                    className="appearance-none relative block w-full pl-10 pr-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" // Adjusted padding for icon
